...
public class Main extends ApplicationAdapter {
    ...
    public void create() {
        ...
        // Erstelle SplineObject als Dreieck
    ...
    public void render() {
        ...
        font.draw(batch, "M = Modus (Ping-Pong / Loop)", 50, 500);
        font.draw(batch, "Pfeiltasten = Geschwindigkeit", 50, 460);
        ...
        font.draw(batch, String.format("Rotation: %.1f°", splineObject.getRotation()), 50, 60);
